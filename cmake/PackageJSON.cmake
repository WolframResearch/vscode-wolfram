  ...
  if(LOCAL_BUILD)
    ...
    execute_process(
      COMMAND
        ...
        #
        ${WOLFRAMKERNEL} -noinit -noprompt -nopaclet -nostartuppaclets -run Pause[${KERNEL_PAUSE}]\;Print[OutputForm[StringReplace["version"\ /.\ Import["${PACKAGEJSON_IN_SOURCE}",\ "JSON"],\ "@"\ ~~\ version___\ ~~\ "@"\ :>\ version]]]\;Exit[]
      OUTPUT_VARIABLE
        PACKAGEJSON_VERSION
